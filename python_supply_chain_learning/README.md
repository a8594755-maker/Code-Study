...
- **Stack:** PostgreSQL (Supabase) · SQL · Python (pandas, Jupyter) · Power BI · VS Code
...
| [tools/sql_playground/](tools/sql_playground/README.md) | 分析師工作室：SQL＋pandas＋Power BI 的 CH1 整合試學、編輯器家教與帳號證據；100 小時全課仍待擴充 |
